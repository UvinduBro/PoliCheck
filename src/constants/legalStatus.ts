...
export const STATUS_BADGE_CLASSES: Record<StatusBadgeKey, string> = {
  ...
  ALLEGATION: "bg-amber-100 text-amber-900 border-amber-300",
  UNDER_INVESTIGATION: "bg-blue-100 text-blue-900 border-blue-300",
  CASE_PENDING: "bg-indigo-100 text-indigo-900 border-indigo-300",
  CONVICTED: "bg-red-100 text-red-900 border-red-300",
  ACQUITTED: "bg-teal-100 text-teal-900 border-teal-300",
  INCARCERATED: "bg-orange-100 text-orange-900 border-orange-300",
